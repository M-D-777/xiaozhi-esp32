...
class Supermini_Pixie_S3_1_28 : public WifiBoard {
private:
...
public:
    Supermini_Pixie_S3_1_28() : boot_button_(BOOT_BUTTON_GPIO) {  
...
DECLARE_BOARD(Supermini_Pixie_S3_1_28);
